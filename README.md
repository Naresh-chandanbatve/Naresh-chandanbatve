...
- Designed PostgreSQL backup strategy with PITR
- Strong in Linux, networking, and debugging
- Love solving interesting engineering challenges
- Reach me at: nareshchandanbatve.dev@gmail.com
- Writing about cloud-native systems and Linux: https://nareshblogs.hashnode.dev
  <br><br>
...
<a href="https://stackoverflow.com/users/18366548/naresh-chandanbatve" target="blank"><img align="center" src="https://img.shields.io/badge/Stack_Overflow-FE7A16?style=for-the-badge&logo=stack-overflow&logoColor=white" alt="naresh_chandanbatve" /></a> 
    ...
    <a href="https://linktr.ee/naresh.dev" target="blank"><img align="center" src="https://img.shields.io/badge/LinkTree-43e660?style=plastic&logo=linktree&logoColor=white" alt="naresh_chandanbatve"/></a> 
...
- **Networking**: VPC design, private networking, load balancer and ingress routing
...
| <a href="https://github.com/Naresh-chandanbatve/eks-terraform"> <img src="https://github-readme-stats-fast.vercel.app/api/pin/?username=Naresh-chandanbatve&repo=eks-terraform&theme=tokyonight" /> </a> <br><br> <ul align="left"><li> Built multi-AZ EKS cluster using Terraform with Karpenter for dynamic, cost-optimized node provisioning</li> <li>Automated CI/CD with GitHub Actions — build, tag with commit SHA, push to ECR, deploy via Helm with auto-rollback</li> <li>Set up full Prometheus & Grafana observability stack with real-time cluster and app metrics</li> <li> Configured TLS automation using cert-manager with NGINX Ingress and AWS ALB for secure external routing</li> <li> Designed modular Terraform structure for VPC and EKS — reusable across environments</li> </ul> | <a href="https://github.com/Naresh-chandanbatve/go-web-server"> <img src="https://github-readme-stats-fast.vercel.app/api/pin/?username=Naresh-chandanbatve&repo=go-web-server&theme=tokyonight" /> </a> <ul align="left"> <br> <li> Built a web server in Go by implementing HTTP request parsing and response handling.</li> <li>Implemented static file serving and reverse proxy to backend services.</li> <li>Added file-based configuration for flexible routing. </li> <li>Handled low-level HTTP lifecycle and request routing logic.</li> </ul> <br><br> |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a href="https://github.com/UBA-GCOEN/StichHub"> <img src="https://github-readme-stats-fast.vercel.app/api/pin/?username=UBA-GCOEN&repo=StichHub&theme=tokyonight" /> </a> <ul align="left"><li> Mentored and was project admin for the project in GSSoC23.</li> <li> have helped many contributors to the project in frontend, backend, and other types of contributions. </li> <li>Built CI-CD pipeline to build and push Image to Docker Hub. </li> <li>Built GitHub Actions workflow to automate collaboration. </li> <li>have developed frontend of tailor dashboard and tailor lists. </li></ul>                                                                                                                                                                                                     | <a href="https://github.com/UBA-GCOEN/ARrow"> <img src="https://github-readme-stats-fast.vercel.app/api/pin/?username=UBA-GCOEN&repo=ARrow&theme=tokyonight" /> </a> <br><ul align="left"><li> Developed the complete backend for the Application in NodeJS.</li> <li>Developed Routes for auth, Google auth, profile edit, Events and Notifications.</li> <li>Integrated libraries like jsonwebtoken, bcrypt, nodemailer, etc. </li> <li> Integrated MongoDB Database to the Backend.</li> </ul> <br>                                                            |
